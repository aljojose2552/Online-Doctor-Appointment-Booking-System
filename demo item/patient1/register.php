...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
  if (matchPassword()) {
    ...
    if ($num_rows) {
      ...
      $sql = "INSERT INTO `patient` (`p_fname`,`p_lname`,`p_username`,`p_email`,`p_address`,`p_city`,`p_state`,`p_pincode`,`p_bloodgroup`,`p_DOB`,`p_phno`,`p_password`,`p_gender`,`Med_history`) VALUES ('$fname','$lname','$username','$email','$address','$city','$state','$pin','$bgroup','$dob','$phno','$password','$gender','$med_his')";
