    ...
    <div class="container">
      ...
      <div class="content">
        ...
        if (isset($_POST['next'])) {
          ...
          $sql = "SELECT * FROM `user_tab` WHERE `user_type`='doctor' AND `username`='$username' AND status=1";
          $sr = mysqli_query($conn, $sql);
          $r1 = mysqli_fetch_array($sr);
        ?>
          <form action="booking.php" method="POST" class="form" name="form">
            <div class="user-details">
              ...
              <div class="input-box">
                ...
                <input type="text" style="display: none;" name="Drname" value="<?php echo $username; ?>">
              </div>
              <div class="input-box">
