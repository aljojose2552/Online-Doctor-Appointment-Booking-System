...
<?php
 ...
 if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
   if (matchPassword()) {
     ...
     $sql = "UPDATE `patient` SET `fname` = '$fname',`lname` = '$lname',`email` = '$email',`address` = '$address',`city` = '$city',`state` = '$state',`pincode` = '$pin',`bloodgroup` = '$bgroup',`dob`='$dob',`phno` = '$phno',`password` = '$password',`gender` = '$gender',`image` = '$imagename',`dept_id` = '$dept' WHERE `username`='$username'";
        ...
        <form action="update.php" method="POST" class="form" enctype="multipart/form-data">
          <div class="user-details">
            ...
            <div class="input-box">
              ...
              <select type="select" name="dept" id="dept" >
