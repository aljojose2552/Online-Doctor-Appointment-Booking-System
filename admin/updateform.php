...
<?php
 ...
 if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
   if (matchPassword()) {
     ...
     $dept = $_POST['dept'];
     $sql = "UPDATE `user_tab` SET `fname` = '$fname',`lname` = '$lname',`email` = '$email',`address` = '$address',`city` = '$city',`state` = '$state',`pincode` = '$pin',`bloodgroup` = '$bgroup',`dob`='$dob',`phno` = '$phno',`password` = '$password',`gender` = '$gender',`dept_id` = '$dept' WHERE `username`='$username'";
        ...
        <form action="updateform.php" method="POST" class="form" enctype="multipart/form-data">
          <div class="user-details">
            ...
            <div class="input-box">
              ...
              <input type="text" name="email" id="email" value="<?php echo $pf["email"]; ?>" required>
            ...
            <div class="input-box">
              ...
              <input type="text" name="phno" id="phno" value="<?php echo $pf["phno"]; ?>" required>
              <p class="message" id="phmsg"></p>
            </div>
            <div class="input-box">
