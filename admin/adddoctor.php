...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
  if (matchPassword()) {
    ...
    if ($num_rows) {
      ...
      $sql = "INSERT INTO `user_tab` (`fname`,`lname`,`username`,`email`,`address`,`city`,`state`,`pincode`,`bloodgroup`,`dob`,`phno`,`password`,`gender`,`dept_id`,`status`,`user_type`) VALUES ('$fname','$lname','$username','$email','$address','$city','$state','$pin','$bgroup','$dob','$phno','$password','$gender','$dept','$statu','doctor')";
        ...
        <form action="adddoctor.php" method="POST" class="form" name="form" enctype="multipart/form-data">
          <div class="user-details">
            ...
            <div class="input-box">
              ...
              <input type="number" name="status"  placeholder="Enter status 0 or 1"  required>
            </div>
